...
Current stable release: **0.1.247**

[Release notes](release-notes/v0.1.247.md).
...
| macOS | [thread0 0.1.247 for macOS](https://storage.googleapis.com/gendistrict-agentdeck-updates/releases/0.1.247/macos/arm64/thread0-0.1.247-arm64.dmg) | macOS 13+, Apple Silicon |
