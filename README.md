...
Current stable release: **0.1.290 for Windows and macOS (Apple Silicon)**. Update both participating PCs before using a collaborator's own AI account.

[Release notes](release-notes/v0.1.290.md).

| Platform | Download | Requirements |
| --- | --- | --- |
| Windows | [thread0 0.1.290 for Windows](https://storage.googleapis.com/gendistrict-agentdeck-updates/releases/0.1.290/windows/x64/thread0%20Setup%200.1.290.exe) | Windows 10/11, x64 |
| macOS | [thread0 0.1.290 for macOS](https://storage.googleapis.com/gendistrict-agentdeck-updates/releases/0.1.290/macos/arm64/thread0-0.1.290-arm64.dmg) | macOS 13+, Apple Silicon |
